...
def remove_node(node_url):
    ...
    response = {
    'message': 'Node removed', 'all_nodes': blockchain.get_peer_nodes()}
...
def create_keys():
    ...
    if wallet.save_keys():
        ...
        return jsonify({'public_key': wallet.public_key, 'private_key': wallet.private_key, 'funds': blockchain.get_balance()}), 201
    else:
...
def get_open_transactions():
    ...
    if open_transactions == None:
        return jsonify({'message': 'No open transactions'}), 404
